package com.coupon.consumer.listener;

import com.coupon.consumer.TestConfig;
...
class CouponIssueListenerTest extends TestConfig {
    ...
    void issue_1() throws JsonProcessingException {
        ...
        sut.issue();
        // then
        verify(couponIssueService, never()).issueV2(anyLong(), anyLong());
    }
    ...
    void issue_2() throws JsonProcessingException {
        ...
        sut.issue();
        // then
        verify(couponIssueService, times(1)).issueV2(couponId, userId);
    }
    ...
    void issue_3() throws JsonProcessingException {
        ...
        inOrder.verify(couponIssueService, times(1)).issueV2(couponId, userId1);
        inOrder.verify(couponIssueService, times(1)).issueV2(couponId, userId2);
        inOrder.verify(couponIssueService, times(1)).issueV2(couponId, userId3);
    }
}
