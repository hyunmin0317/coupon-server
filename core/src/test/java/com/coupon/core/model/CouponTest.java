...
class CouponTest {
    ...
    public void availableIssueQuantity_1() throws Exception {
        //given
    ...
    public void availableIssueQuantity_2() throws Exception {
        //given
        Coupon coupon = Coupon.builder()
                .totalQuantity(100)
                .issuedQuantity(100)
    ...
    public void availableIssueQuantity_3() throws Exception {
        //given
        Coupon coupon = Coupon.builder()
                .totalQuantity(null)
                .issuedQuantity(100)
    ...
    public void availableIssueDate_1() throws Exception {
        //given
        Coupon coupon = Coupon.builder()
    ...
    public void availableIssueDate_2() throws Exception {
        //given
        Coupon coupon = Coupon.builder()
    ...
    public void availableIssueDate_3() throws Exception {
        //given
        Coupon coupon = Coupon.builder()
